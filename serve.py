...
Usage examples:
  ...
  python serve.py --format g_retriever --source ./data/rag_storage/g_retriever/scene_graphs
  ...
  python serve.py \
    --graph fastinsight:./data/rag_storage/fastinsight/scifact-bge-m3 \
    --graph lightrag:./data/rag_storage/lightrag/bsard \
    --graph hipporag:./data/rag_storage/hipporag/2wikimultihopqa/gpt-4o-mini_nvidia_NV-Embed-v2 \
    --graph g_retriever:./data/rag_storage/g_retriever/scene_graphs \
    --graph expla_graphs:./data/rag_storage/expla_graphs \
